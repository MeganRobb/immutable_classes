 ...
 * @author student
 */
public class SellingHandbags {
     private String stockID;
    private double sellingPrice;
    private double tax;
    private double costPrice;
    
     private SellingHandbags(){
   
    }
      private SellingHandbags(Builder builder){
    ...
    private double costPrice;
        ...
        public SellingHandbags build(){
            return new SellingHandbags(this);
        }
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + (this.stockID != null ? this.stockID.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final SellingHandbags other = (SellingHandbags) obj;
